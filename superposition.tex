...
\cmt to set up a stationary sound wave, we need two travelling wave in opposite directions
...
\question{
	A diffraction pattern is observed when monochromatic light is incident on a diffraction grating. If another diffraction grating with twice as many lines per millimetre is used, suggest the possible effects to (a) the total number of diffraction maxima, (b) the angle between the first and second order.
}
