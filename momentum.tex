...
\begin{ilight}
	\keypoint{momentum} of an object is defined as the product of its mass and its velocity: $\boxed{p=mv}$ \index{momentum}
\end{ilight}
...
\begin{ilight}
	\keypoint{force} is defined as the rate of change in momentum: $\boxed{F = \frac{\Delta p}{\Delta t}}$ \index{force}
\end{ilight}
