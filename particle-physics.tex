...
\cmt proton number $Z$ can be further interpreted as \keypoint{charge number} of the particle
...
\cmt nucleon number $A$ can be interpreted as \keypoint{mass number} of the particle
...
\cmt conservation of mass-energy\index{mass-energy conservation}
...
therefore an $\alpha$-decay is simply an $\alpha$-particle escaping from the nucleus
...
\cmt quarks can combine to form composite particles called \keypoint{hadrons}

there are two ways that several quarks can make up a hadron

\begin{compactenum}
	\item[--] hadrons can be made up of three quarks (qqq), called \keypoint{baryons}
	...
	\item[--] hadrons can also be made up of one quark and one anti-quark (q$\bar{\text{q}}$), called \keypoint{mesons}
...
another type of the elementary matter particle is the \keypoint{lepton}\index{quark}
...
classification of sub-atomic particles required by the A-Level syllabus\footnote{This is an over-simplified version of the Standard Model. I only included the particles that you need to know for the A-Level exams. There are a lot of missing pieces that are way beyond the scope of our course.} is summarised below
